...
**RailVideoTrimは、AIもクラウドも使用しません。**

-  **完全オフライン**
  動画解析はすべてお使いのPC上で行われます。
  動画をクラウドへアップロードする必要はありません。

-  **AI不使用**
  AIサービスやAI APIには動画を送信しません。
  独自の画像解析と判定ロジックによって変化を検出します。

-  **再エンコードなし**
  検出した区間は、可能な限りFFmpegの`-c copy`によって
  無劣化で切り出します。

> **大切な動画を、あなたのPCから外へ出す必要はありません。**
